#include <string.h>
#include <jni.h>
#include "io_ipstack_net_tuntap_TuntapSocket.h"
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_open(JNIEnv* env, jobject obj, jboolean tun_j, jstring name_j)
{
	return Java_io_ipstack_net_tuntap_TuntapSocket_openDev(env,obj,tun_j,name_j,NULL);
}


JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_openDev(JNIEnv* env, jobject obj, jboolean tun_j, jstring name_j, jstring dev_file_j)
{
	struct ifreq ifr;
	long fd, err;
    const char* devname;
...
JNIEXPORT void JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_close(JNIEnv* env, jobject obj, jint fd)
{
	close(fd);
}


JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_write(JNIEnv* env, jobject obj, jint fd, jbyteArray data_j, jint off, jint len)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_read(JNIEnv* env, jobject obj, jint fd, jbyteArray data_j, jint off)
{

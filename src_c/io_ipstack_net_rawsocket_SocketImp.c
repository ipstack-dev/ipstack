...
#include <jni.h>
#include "io_ipstack_net_rawsocket_Socket.h"
...
JNIEXPORT void JNICALL Java_io_ipstack_net_rawsocket_Socket_startup(JNIEnv* env, jclass class)
{
   #ifdef _WIN32
    // start Winsock2
   WSADATA wsinfo;
...
JNIEXPORT void JNICALL Java_io_ipstack_net_rawsocket_Socket_cleanup(JNIEnv* env, jclass class)
{
   #ifdef _WIN32
   // clean Winsock2
   WSACleanup();
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_getPFINET6(JNIEnv* env, jclass class)
{  return (jint)PF_INET6;
}


JNIEXPORT void JNICALL Java_io_ipstack_net_rawsocket_Socket_setdebug(JNIEnv* env, jclass class, jboolean enable)
{  DEBUG=enable;
}


JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_socket(JNIEnv* env, jobject obj, jint domain, jint type, jint protocol)
{
...
JNIEXPORT void JNICALL Java_io_ipstack_net_rawsocket_Socket_close(JNIEnv* env, jobject obj, jint sock)
{  close(sock);
}

/*JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_bindAllAddresses(JNIEnv* env, jobject obj, jint sock, jint sa_family)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_bind(JNIEnv* env, jobject obj, jint sock, jint sa_family, jbyteArray ipaddr_j, jint port)
{
...
/*JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_bind(JNIEnv* env, jobject obj, jint sock, jbyteArray addr_j, jint addrlen)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_sendto(JNIEnv* env, jobject obj, jint sock, jbyteArray data_j, jint off, jint len, jint flags, jint sa_family, jstring daddr_j, jint port)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_recv(JNIEnv* env, jobject obj, jint sock, jbyteArray data_j, jint off, jint flags)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_recvfrom(JNIEnv* env, jobject obj, jint sock, jbyteArray data_j, jint off, jint flags, jbyteArray addr_j, jbyteArray port_j)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_setsockopt(JNIEnv* env, jobject obj, jint sock, jint level, jint opt, jbyteArray value_j, jint off, jint len)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_rawsocket_Socket_getsockopt(JNIEnv* env, jobject obj, jint sock, jint level, jint opt, jbyteArray value_j, jint off)
{

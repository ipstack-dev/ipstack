...
JNIEXPORT jlong JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_open(JNIEnv* env, jobject obj, jboolean tun_j, jstring name_j)
{
...
JNIEXPORT void JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_close(JNIEnv* env, jobject obj, jlong fd)
{
	close(fd);
}


JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_write(JNIEnv* env, jobject obj, jlong fd, jbyteArray data_j, jint off, jint len)
{
...
JNIEXPORT jint JNICALL Java_io_ipstack_net_tuntap_TuntapSocket_read(JNIEnv* env, jobject obj, jlong fd, jbyteArray data_j, jint off)
{
